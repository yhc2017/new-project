...
<script>
    ...
    btn.addEventListener("click",function(){
//        var ttval = document.getElementById("textarea").value;
//        var url = "show.php";
//        $.post(url,{content:ttval},function(data){
...
//        });
        ...
        <!--        --><?php
//        echo "<script>var jj = UE.getEditor('editor').getContent();
//        var kk = document.getElementById(\"titleid\").value;</script>";
//            $newsTiele = "<script>kk;</script>";
//            $newsContent ="<script>jj;</script>";
//
...
//// 创建新文件
////        tf = fso.CreateTextFile("F://appserv/www/software3/public/article/testfile.txt", true);
//        tf = fso.CreateTextFile("d://testfile.txt", true);
//// 填写数据，并增加换行符
